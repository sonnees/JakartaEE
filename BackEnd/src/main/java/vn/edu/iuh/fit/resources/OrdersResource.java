...
public class OrdersResource {
    ...
    public Response getAnalYearMonthDay(ReqObject3Field reqObject3Field){
        System.out.println(reqObject3Field);
        List<ReqObject2Field> analYearMonthDay = ordersSer.getAnalYearMonthDay(reqObject3Field);
        System.out.println(analYearMonthDay);
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public Response getAnalYearMonthDays(ReqObject3Field reqObject3Field){
        List<ReqObject2Field> analYearMonths = ordersSer.getAnalYearMonths(reqObject3Field);
